...
const LiminOSDatabase = {
    levels: {
        "level0": {
            ...
            mapConfig: { seed: 7492, wallDensity: 0.65, gridSize: 5, poiChance: 0.012, renderStyle: 'grid', wallColor: '#eab308', gridColor: 'rgba(255,255,255,0.05)', wallThickness: 0.15, bgColor: '#030303', pois: [ { name: "Gateway Node", color: "#9ca3af", icon: "⬇" }, { name: "Almond Puddle", color: "#60a5fa", icon: "💧" }, { name: "Wall Tear", color: "#ef4444", icon: "⚡" }, { name: "Fluorescent Trap", color: "#eab308", icon: "💡" }, { name: "Carpet Sink", color: "#22c55e", icon: "🕳" }, { name: "Null Zone", color: "#a855f7", icon: "🌪" }, { name: "Manila Door", color: "#f97316", icon: "🚪" }, { name: "Loop Start", color: "#14b8a6", icon: "🔄" }, { name: "M.E.G. Marker", color: "#3b82f6", icon: "🛡" } ] },
            specificMetrics: { "Level 0 Proprietary Data": { "Carpet Saturation Depth": "1.2cm (Avg)", "Wallpaper Decay Rate": "0% (Indestructible)", "Fluorescent Flicker Rate": "0.4 Hz", "Must Scent Density": "High", "Layout Generation Speed": "Instantaneous", "Electromagnetic Spike": "Random" } },
            globalMetrics: [
                { category: "Chrono-Temporal Dynamics", icon: "ph-hourglass", color: "text-teal-400", data: { "Time Dilation": "1:0.004", "Loop Probability": "14.2%", "Entropy Gradient": "Stagnant", "Clock Drift": "+14s/hr", "Subjective Time": "Stretched", "Causality Integrity": "92.1%", "Temporal Echoes": "High", "Chronon Rad": "1.2 ppm", "Aging Rate": "Nullified" } },
                { category: "Spatial & Dimensional", icon: "ph-intersect", color: "text-purple-400", data: { "Hume Level": "82.4 H (Low)", "Kant Counter": "0.85", "Euclidean Consistency": "14.2%", "Noclipping Threshold": "Permeable", "Gravity Variance": "9.81 m/s²", "Z-Axis Deviation": "2.4%", "Magnetic Declination": "Spinning", "Corridor Gen Rate": "4000 m/s" } },
                { category: "Atmospheric Diagnostics", icon: "ph-wind", color: "text-blue-400", data: { "Ambient Temp": "22.4 °C", "Temp Fluctuation": "±0.1 °C", "Relative Humidity": "48%", "Pressure": "100.1 kPa", "Air Comp O2": "20.1%", "Air Comp N2": "79.0%", "Mold Spores": "Trace", "Toxicity": "0%", "Breathability": "100%" } },
                { category: "Acoustic & Luminescent", icon: "ph-waveform", color: "text-yellow-400", data: { "Ambient Hum": "59.8 Hz", "Acoustic Decay": "Rapid", "Light Source": "Fluorescents", "Luminosity Level": "300 Lux", "Color Temp": "3200K", "Audio Hallucination": "34%", "Decibel Baseline": "45 dB", "Echo Delay": "0.5s" } },
                { category: "Material & Biological", icon: "ph-flask", color: "text-green-400", data: { "Floor Material": "Damp Carpet", "Fluid Composition": "Musty Water", "Entity Density": "0.001", "Pathogen Level": "Sterile", "Structural Integrity": "Perfect", "Nutrient Avail": "Zero", "Dehydration Risk": "Extreme", "Flora/Fauna": "None" } },
                { category: "Survival & Infrastructure", icon: "ph-shield", color: "text-red-400", data: { "Base Threat Level": "1", "Sanity Drain Rate": "2.5% / hr", "Isolation Factor": "Absolute", "Radio Comm": "0% (Blocked)", "GPS Function": "Offline", "Shelter Viability": "0/100", "Resource Respawn": "None", "Navigation Difficulty": "Maximum" } }
            ],
            lore: makeLore([
            ...
            survivalGuide: makeSG(
                [
                    {n:"Psychological Anchoring", d:"The hum-buzz and mono-yellow aesthetic induce rapid monophobia and sensory deprivation loop. The brain will attempt to create stimuli where there is none.", c:"purple", l:"Carry a mechanical watch. The ticking overrides the hum-buzz and provides a Baseline anchor."},
                    {n:"Resource Management", d:"There is absolutely no clean water natively generated here. Drinking the carpet fluid results in severe gastrointestinal distress.", c:"yellow", l:"Search specifically for pooling condensation near structural anomalies or broken lights."},
                    ...
                    {n:"Hallucination Rejection", d:"You will hear voices of people you know calling for help. This is the architecture attempting to lure you into a dead end.", c:"fuchsia", l:"Bite your lip hard. Physical pain disrupts the cognitohazard loop immediately."} // 5
                ], 
                [ {n:"Analog Watch",i:"ph-watch"}, {n:"Almond Water",i:"ph-drop"}, {n:"Industrial Chalk",i:"ph-pencil-simple"}, {n:"Thick Boots",i:"ph-boot"}, {n:"Blindfold",i:"ph-eye-closed"}, {n:"Earplugs",i:"ph-ear-slash"}, {n:"Backpack",i:"ph-bag"}, {n:"Notepad",i:"ph-book"} ] // 8
            ),
            history: makeHist([
                {date: "1991-08-14", t: "First Archival Record", d: "An anonymous user uploaded the first verified visual telemetry of Level 0 to a rudimentary web forum. The image was analyzed and confirmed to contain no digital manipulation, proving the existence of the Backrooms geometry. This sparked the initial wave of L-Corp clandestine investigations into spatial tears."},
                {date: "1998-02-03", t: "Project 'Yellow Wallpaper'", d: "The first batch of unmanned, tethered probes were sent through a localized spatial tear in an abandoned mall. The probes mapped a 10-mile radius before the tether was cleanly severed by an invisible spatial fold. Telemetry confirmed the exact Hume level drop."},
                {date: "2004-11-21", t: "Spatial Paradox Recorded", d: "An L-Corp drone successfully mapped a hallway that intersected itself at a perfect 90-degree angle without connecting to its own origin point. This proved the Euclidean consistency of Level 0 was below 15%, forcing a massive rewrite of standard physics models."},
                {date: "2012-06-08", t: "M.E.G. Isolation Study", d: "A volunteer spent 40 hours inside a tethered zone. The subject reported hearing the ceiling lights speak in the voice of their deceased mother. The subject required 6 months of psychiatric rehabilitation upon extraction, cementing the level as a Cognitohazard."},
                ...
                {date: "2026-07-02", t: "L-Corp Outpost Zero", d: "L-Corp has successfully stabilized a micro-tear allowing for consistent, one-way insertion of field agents into the Lobby. Entity density remains flat at zero, but sanity drain metrics are higher than projected. Field teams are advised to transit to Level 1 within 12 hours of insertion to avoid permanent cognitive damage."} // 6
            ]),
        ...
        "level1": {
            ...
            mapConfig: { seed: 99120, wallDensity: 0.35, renderStyle: 'warehouse', gridSize: 12, poiChance: 0.05, wallColor: '#52525b', gridColor: 'rgba(255,255,255,0.02)', wallThickness: 0.3, bgColor: '#18181b', pois: [ { name: "M.E.G. Alpha", color: "#22c55e", icon: "🛡" }, { name: "Supply Crate", color: "#3b82f6", icon: "📦" }, { name: "Flickering Light", color: "#eab308", icon: "💡" }, { name: "Fog Choke Point", color: "#a855f7", icon: "🌫" }, { name: "Hound Pack", color: "#ef4444", icon: "🐾" }, { name: "Generator", color: "#f97316", icon: "⚡" }, { name: "Concrete Pillar", color: "#9ca3af", icon: "🏢" }, { name: "Chalk Marker", color: "#06b6d4", icon: "✏" }, { name: "Water Puddle", color: "#60a5fa", icon: "💧" }, { name: "B.N.T.G Vault", color: "#eab308", icon: "🏦" }, { name: "Skin-Stealer", color: "#ec4899", icon: "👤" }, { name: "False Door", color: "#14b8a6", icon: "🚪" }, { name: "Smiler Nest", color: "#ffffff", icon: "👁" }, { name: "Scrap Pile", color: "#71717a", icon: "🔩" }, { name: "Elevator Shaft", color: "#10b981", icon: "🛗" } ] },
            specificMetrics: { "Level 1 Proprietary Data": { "Concrete Density": "2400 kg/m³", "Fog Metallic Content": "14 ppm", "Crate Spawn Algorithm": "Fibonacci Sequence", "Blackout Duration": "14.2 Hours", "Rebar Rust Rate": "Minimal", "Generator Output": "220V/50Hz", "Puddle Depth": "2.4cm", "Airborne Dust": "Low" } },
            globalMetrics: [
                { category: "Chrono-Temporal Dynamics", icon: "ph-hourglass", color: "text-teal-400", data: { "Time Dilation": "1:1.0", "Loop Probability": "0.1%", "Entropy Gradient": "Normal", "Clock Drift": "±0.0s/hr", "Subjective Time": "Linear", "Causality Integrity": "99.8%", "Temporal Echoes": "None", "Chronon Rad": "0.1 ppm", "Aging Rate": "Standard" } },
                { category: "Spatial & Dimensional", icon: "ph-intersect", color: "text-purple-400", data: { "Hume Level": "95.2 H", "Kant Counter": "1.05", "Euclidean Consistency": "80.0%", "Noclipping Threshold": "Difficult", "Gravity Variance": "9.81 m/s²", "Z-Axis Deviation": "0.0%", "Magnetic Declination": "Standard", "Corridor Gen Rate": "100 m/s" } },
                { category: "Atmospheric Diagnostics", icon: "ph-wind", color: "text-blue-400", data: { "Ambient Temp": "15.0 °C", "Temp Fluctuation": "±5.0 °C", "Relative Humidity": "85%", "Pressure": "102.1 kPa", "Air Comp O2": "19.2%", "Air Comp N2": "78.5%", "Mold Spores": "Moderate", "Toxicity": "0.5%", "Breathability": "95%" } },
                { category: "Acoustic & Luminescent", icon: "ph-waveform", color: "text-yellow-400", data: { "Ambient Hum": "Machinery Whir", "Acoustic Decay": "Dampened", "Light Source": "Industrial Bulbs", "Luminosity Level": "150 Lux", "Color Temp": "4000K", "Audio Hallucination": "2%", "Decibel Baseline": "55 dB", "Echo Delay": "1.2s" } },
                { category: "Material & Biological", icon: "ph-flask", color: "text-green-400", data: { "Floor Material": "Concrete", "Wall Decay": "2%", "Entity Density": "0.08", "Pathogen Level": "Low", "Structural Integrity": "High", "Nutrient Avail": "Moderate", "Dehydration Risk": "Low", "Flora/Fauna": "Mildew" } },
                { category: "Survival & Infrastructure", icon: "ph-shield", color: "text-red-400", data: { "Base Threat Level": "2", "Sanity Drain Rate": "0.1% / hr", "Isolation Factor": "Low", "Radio Comm": "Functional", "GPS Function": "Intermittent", "Shelter Viability": "90/100", "Resource Respawn": "Active", "Navigation Difficulty": "Moderate" } }
            ],
            lore: makeLore([
                ...
                ["Walking down an excessively long hallway transitions smoothly into Level 2.", "Entering a hole in the concrete wall drops the wanderer into Level 19.", "Unlocking a specific red shipping container leads to Level 3.", "Sleeping inside a supply crate sometimes wakes you up in Level 4."] // 4 (Total 9)
            ),
            survivalGuide: makeSG(
                [
                ...
                [ {n:"High-Lumen Flashlight",i:"ph-flashlight"}, {n:"Respirator Mask",i:"ph-mask-water"}, {n:"Crowbar",i:"ph-wrench"}, {n:"Blue Chalk",i:"ph-pencil"}, {n:"Combat Knife",i:"ph-knife"}, {n:"Extra Batteries",i:"ph-battery-full"}, {n:"Almond Water",i:"ph-drop"}, {n:"Sleeping Bag",i:"ph-sleeping-bag"}, {n:"Two-way Radio",i:"ph-radio"}, {n:"Duct Tape",i:"ph-tape"} ] // 10
            ),
            history: makeHist([
                {date: "1994-05-11", t: "First Successful Transition", d: "A wanderer posted a blurry photo of a concrete pillar on an obscure imageboard, marking the discovery of Level 1. The image showed a distinct lack of yellow wallpaper, confirming a multi-tiered structure to the Backrooms. The wanderer described finding crates of water."},
                ...
                {date: "2012-03-11", t: "B.N.T.G. Trade Route Established", d: "The B.N.T.G. successfully charted a reliable trade route from Base Alpha to the exits leading to Level 4, allowing the flow of supplies and weapons."},
                ...
                {date: "2026-07-02", t: "Base Alpha Thriving", d: "Current population exceeds 800 active residents. The fog toxicity levels remain stable, though L-Corp nodes detect a slight increase in Hume instability near the western expansion zones. Trade routes to Level 4 are fully operational and heavily guarded."} // 8
            ]),
        ...
        "level2": {
            ...
            mapConfig: { seed: 8847, wallDensity: 0.9, renderStyle: 'pipes', gridSize: 6, poiChance: 0.05, wallColor: '#991b1b', gridColor: 'rgba(255,0,0,0.05)', wallThickness: 0.4, bgColor: '#0a0000', pois: [ { name: "Superheated Valve", color: "#ef4444", icon: "🔥" }, { name: "Clump Nest", color: "#d946ef", icon: "🕸" }, { name: "Burst Pipe", color: "#60a5fa", icon: "💧" }, { name: "Dead End", color: "#9ca3af", icon: "🛑" }, { name: "Smiler Zone", color: "#ffffff", icon: "👁" }, { name: "Locked Fire Door", color: "#f97316", icon: "🚪" }, { name: "Maintenance Hatch", color: "#22c55e", icon: "🕳" }, { name: "Boiler Machine", color: "#eab308", icon: "⚙" }, { name: "M.E.G. Cache", color: "#3b82f6", icon: "🛡" }, { name: "Thermal Anomaly", color: "#ec4899", icon: "🌡" }, { name: "Acid Sludge", color: "#14b8a6", icon: "🧪" }, { name: "Rusty Ladder", color: "#71717a", icon: "🪜" }, { name: "Steam Vent", color: "#f43f5e", icon: "💨" }, { name: "Crawling Space", color: "#8b5cf6", icon: "🕷" }, { name: "Breach Wall", color: "#10b981", icon: "🧱" }, { name: "Skin-Stealer", color: "#0ea5e9", icon: "👤" }, { name: "Hound Pack", color: "#d97706", icon: "🐾" }, { name: "Abandoned Bag", color: "#64748b", icon: "🎒" } ] },
            specificMetrics: { "Level 2 Proprietary Data": { "Pipe Thermal Output": "Max 43°C", "Steam Pressure Level": "1200 PSI", "Iron Oxidation Rate": "Accelerated", "Acoustic Pipe Groans": "90 dB", "Hallway Width": "0.8m to 1.5m", "Acidic Sludge Flow": "2 L/min", "Ventilation Draft": "Hot/Stagnant", "Ambient Sparking": "Frequent" } },
            globalMetrics: [
                { category: "Chrono-Temporal Dynamics", icon: "ph-hourglass", color: "text-teal-400", data: { "Time Dilation": "1:1.2", "Loop Probability": "5.0%", "Entropy Gradient": "Accelerated", "Clock Drift": "-2s/hr", "Subjective Time": "Rushed", "Causality Integrity": "95.0%", "Temporal Echoes": "Low", "Chronon Rad": "2.4 ppm", "Aging Rate": "Standard" } },
                { category: "Spatial & Dimensional", icon: "ph-intersect", color: "text-purple-400", data: { "Hume Level": "75.0 H", "Kant Counter": "1.15", "Euclidean Consistency": "60.0%", "Noclipping Threshold": "Moderate", "Gravity Variance": "9.81 m/s²", "Z-Axis Deviation": "1.2%", "Magnetic Declination": "Standard", "Corridor Gen Rate": "200 m/s" } },
                { category: "Atmospheric Diagnostics", icon: "ph-wind", color: "text-blue-400", data: { "Ambient Temp": "38.0 °C", "Temp Fluctuation": "±15.0 °C", "Relative Humidity": "95%", "Pressure": "105.2 kPa", "Air Comp O2": "18.5%", "Air Comp N2": "75.0%", "Mold Spores": "High", "Toxicity": "2.0%", "Breathability": "70%" } },
                { category: "Acoustic & Luminescent", icon: "ph-waveform", color: "text-yellow-400", data: { "Ambient Hum": "Pipe Groans", "Acoustic Decay": "Echoing", "Light Source": "Flickering Bulbs", "Luminosity Level": "40 Lux", "Color Temp": "2500K", "Audio Hallucination": "10%", "Decibel Baseline": "85 dB", "Echo Delay": "2.5s" } },
                { category: "Material & Biological", icon: "ph-flask", color: "text-green-400", data: { "Floor Material": "Grates", "Pipe Material": "Rusted Iron", "Entity Density": "1.40", "Pathogen Level": "Moderate", "Structural Integrity": "Failing", "Nutrient Avail": "Zero", "Dehydration Risk": "Extreme", "Water Toxicity": "Lethal" } },
                { category: "Survival & Infrastructure", icon: "ph-shield", color: "text-red-400", data: { "Base Threat Level": "3", "Sanity Drain Rate": "1.5% / hr", "Isolation Factor": "Moderate", "Radio Comm": "Poor", "GPS Function": "Offline", "Shelter Viability": "10/100", "Resource Respawn": "None", "Navigation Difficulty": "High" } }
            ],
            lore: makeLore([
            ...
            survivalGuide: makeSG(
                ...
                [ {n:"Thermometer",i:"ph-thermometer"}, {n:"5L Thermal Water Jug",i:"ph-drop"}, {n:"Burn Salve",i:"ph-first-aid"}, {n:"Glowsticks",i:"ph-lightbulb"}, {n:"Heat Gloves",i:"ph-hand-palm"}, {n:"Heavy Crowbar",i:"ph-wrench"}, {n:"Cooling Towel",i:"ph-t-shirt"}, {n:"Thick Boots",i:"ph-boot"}, {n:"Compass",i:"ph-compass"}, {n:"Respirator",i:"ph-mask-water"}, {n:"Adrenaline",i:"ph-syringe"}, {n:"Flashlight",i:"ph-flashlight"} ] // 12
            ),
            history: makeHist([
                ...
                {date: "1998-09-05", t: "First Smiler Casualty", d: "A wanderer's camera was recovered near a dark stretch of hallway. The final frame showed the glowing teeth of Entity 3, cementing the danger of the unlit sectors."},
                ...
                {date: "2004-11-12", t: "Acid Sludge Identified", d: "A scientific team extracted samples from the black pipes. The fluid was found to be highly corrosive, easily dissolving organic matter and standard rubber boots."},
                ...
                {date: "2010-06-30", t: "The 30-Day Survivor", d: "A heavily scarred wanderer emerged into Level 4 after surviving in Level 2 for 30 days by drinking condensation and eating moss. Their survival techniques formed the core of the current L-Corp manual."},
                ...
                {date: "2017-01-22", t: "Hound Culling Attempt", d: "M.E.G. sent a heavily armed strike team to reduce the Hound population. The team was successful but suffered 50% casualties due to the claustrophobic fighting conditions."},
                {date: "2021-08-11", t: "L-Corp Thermal Scan", d: "Deployment of autonomous rovers successfully mapped temperature gradients and identified optimal, cooler paths through the maze, avoiding the 43°C zones."},
                {date: "2026-07-02", t: "Transit Only Status", d: "Due to rising thermal metrics (averaging 40°C), Level 2 is officially classified as a transit-only zone. No outposts are currently active. L-Corp telemetry indicates a massive pressure buildup in the northern quadrant."} // 10
            ]),
        ...
        "level3": {
            ...
            specificMetrics: { "Level 3 Proprietary Data": { "Ambient Voltage Level": "10,000V", "Electromagnetic Interference": "Severe", "Metal Grating Oxidation": "5%", "Machinery RPM": "14,000", "Spark Frequency": "0.8 Hz", "Transformer Heat Output": "High", "Cable Insulation Thickness": "Failing", "Grid Load Variance": "Erratic" } },
            globalMetrics: [
                { category: "Chrono-Temporal Dynamics", icon: "ph-hourglass", color: "text-teal-400", data: { "Time Dilation": "1:0.9", "Loop Probability": "1.0%", "Entropy Gradient": "Normal", "Clock Drift": "+5s/hr", "Subjective Time": "Disjointed", "Causality Integrity": "90.0%", "Temporal Echoes": "Moderate", "Chronon Rad": "1.8 ppm", "Aging Rate": "Standard" } },
                { category: "Spatial & Dimensional", icon: "ph-intersect", color: "text-purple-400", data: { "Hume Level": "70.0 H", "Kant Counter": "1.30", "Euclidean Consistency": "40.0%", "Noclipping Threshold": "Low", "Gravity Variance": "9.81 m/s²", "Z-Axis Deviation": "5.0%", "Magnetic Declination": "Wild", "Corridor Gen Rate": "800 m/s" } },
                { category: "Atmospheric Diagnostics", icon: "ph-wind", color: "text-blue-400", data: { "Ambient Temp": "25.0 °C", "Temp Fluctuation": "±2.0 °C", "Relative Humidity": "60%", "Pressure": "100.5 kPa", "Air Comp O2": "20.0%", "Air Comp N2": "78.0%", "Mold Spores": "Low", "Toxicity": "0.5%", "Breathability": "90%" } },
                { category: "Acoustic & Luminescent", icon: "ph-waveform", color: "text-yellow-400", data: { "Ambient Hum": "120 dB", "Acoustic Decay": "Zero", "Light Source": "Sparks/Strobes", "Luminosity Level": "Variable", "Color Temp": "5000K", "Audio Hallucination": "0%", "Decibel Baseline": "100 dB", "Echo Delay": "0.1s" } },
                { category: "Material & Biological", icon: "ph-flask", color: "text-green-400", data: { "Floor Material": "Metal Grating", "Voltage Level": "10,000V", "Entity Density": "3.50", "Pathogen Level": "Low", "Structural Integrity": "Sturdy", "Nutrient Avail": "None", "Dehydration Risk": "Moderate", "Flora/Fauna": "None" } },
                { category: "Survival & Infrastructure", icon: "ph-shield", color: "text-red-400", data: { "Base Threat Level": "4", "Sanity Drain Rate": "3.0% / hr", "Isolation Factor": "None", "Radio Comm": "0%", "GPS Function": "Offline", "Shelter Viability": "0/100", "Resource Respawn": "None", "Navigation Difficulty": "Extreme" } }
            ],
            lore: makeLore([
                ...
                ["Opening a fire exit door in Level 2.", "Unlocking a specific red shipping container in Level 1.", "Crawling through a dense thicket of black wires in Level 6.", "Opening a breaker box in Level 11 and crawling inside."], // 4
                ["Finding a working elevator and riding it upwards takes you to Level 4.", "Entering a specific maintenance hatch drops you into Level 5.", "Noclipping through a brick wall while being electrocuted leads to Level 12.", "Finding a rusted car in a wide hallway leads to Level 69."] // 4 (Total 8)
            ),
            survivalGuide: makeSG(
                [
        ...
        "level4": {
            ...
            specificMetrics: { "Level 4 Proprietary Data": { "Cubicle Density": "75%", "Carpet Cleanliness": "Pristine", "Fluorescent Flicker Rate": "0%", "Vending Restock Rate": "14 Days", "Wi-Fi Signal Strength": "Moderate", "Ink Toner Presence": "Infinite", "Coffee Spoilage Time": "Never", "Ceiling Tile Drop Risk": "Zero", "Window Trap Ratio": "1 in 500" } },
            globalMetrics: [
                { category: "Chrono-Temporal Dynamics", icon: "ph-hourglass", color: "text-teal-400", data: { "Time Dilation": "1:1.0", "Loop Probability": "0.0%", "Entropy Gradient": "Normal", "Clock Drift": "0s/hr", "Subjective Time": "Relaxed", "Causality Integrity": "100%", "Temporal Echoes": "None", "Chronon Rad": "0.0 ppm", "Aging Rate": "Standard" } },
                { category: "Spatial & Dimensional", icon: "ph-intersect", color: "text-purple-400", data: { "Hume Level": "99.0 H", "Kant Counter": "1.01", "Euclidean Consistency": "95.0%", "Noclipping Threshold": "Hard", "Gravity Variance": "9.81 m/s²", "Z-Axis Deviation": "0.0%", "Magnetic Declination": "Standard", "Corridor Gen Rate": "10 m/s" } },
                { category: "Atmospheric Diagnostics", icon: "ph-wind", color: "text-blue-400", data: { "Ambient Temp": "21.0 °C", "Temp Fluctuation": "±0.5 °C", "Relative Humidity": "45%", "Pressure": "101.3 kPa", "Air Comp O2": "21.0%", "Air Comp N2": "78.0%", "Mold Spores": "Zero", "Toxicity": "0%", "Breathability": "100%" } },
                { category: "Acoustic & Luminescent", icon: "ph-waveform", color: "text-yellow-400", data: { "Ambient Hum": "Low AC Whir", "Acoustic Decay": "Standard", "Light Source": "Fluorescents", "Luminosity Level": "400 Lux", "Color Temp": "5000K", "Audio Hallucination": "0%", "Decibel Baseline": "40 dB", "Echo Delay": "0.2s" } },
                { category: "Material & Biological", icon: "ph-flask", color: "text-green-400", data: { "Floor Material": "Thin Carpet", "Wall Decay": "0%", "Entity Density": "0.01", "Pathogen Level": "Sterile", "Structural Integrity": "Perfect", "Nutrient Avail": "High", "Dehydration Risk": "Zero", "Flora/Fauna": "None" } },
                { category: "Survival & Infrastructure", icon: "ph-shield", color: "text-red-400", data: { "Base Threat Level": "0.5", "Sanity Drain Rate": "Restorative", "Isolation Factor": "Low", "Radio Comm": "Perfect", "GPS Function": "Online", "Shelter Viability": "100/100", "Resource Respawn": "Active", "Navigation Difficulty": "Low" } }
            ],
            lore: makeLore([
                ...
                ["Exiting an elevator ascending from Level 3.", "Opening an office door in Level 2.", "Falling through the ceiling of Level 5.", "Sleeping inside a supply crate in Level 1.", "Entering a glass door in Level 11."], // 5
                ["Walking down a grand staircase transitions smoothly to Level 5.", "Noclipping through a filing cabinet leads to Level 6.", "Drinking from a poisoned water cooler transports you to Level 7.", "Jumping out of a real window drops you into Level 11.", "Finding a heavy vault door leads to Level 10."] // 5 (Total 10)
            ),
            survivalGuide: makeSG(
                [
    ...
    entities: {
        "entity1": {
            ...
            specificMetrics: { "Entity 1 Specifics": { "Flash Luminosity": "15,000 Lumens", "Audio Shutter Volume": "80 dB", "Camera Make": "Unknown/Anomalous", "Interaction Range": "Omnipresent", "Data Injection Speed": "Instantaneous", "Footprint Generation": "Zero", "Thermal Trace": "Zero" } },
            globalMetrics: [
            ...
            lore: makeLore([
                ...
                ["Appears randomly across any level without warning.", "Manifests instantly if a wanderer discovers a previously uncharted transition point.", "Triggers when a wanderer is perfectly still for 48 hours."],
                ["Fades out of reality within 1.4 seconds of taking a photograph.", "Leaves behind a polaroid film that acts as an anchor to reality."]
            ),
            survivalGuide: makeSG(
                [
        ...
        "entity2": {
            ...
            specificMetrics: { "Entity 2 Proprietary Data": { "Glass Tensile Strength": "Unbreakable", "Reach Distance": "1.5 Meters", "Illusion Type": "Psychic Memory Projection", "Shadow Mass": "Void Matter", "Preferred Target": "Homesick Humans", "Lure Radius": "10 Meters", "Vibration Frequency": "14 Hz", "Shatter Sound Level": "110 dB" } },
            globalMetrics: [
                ...
                { category: "Dimensional Limits", icon: "ph-intersect", color: "text-purple-400", data: { "Noclip Capability": "None", "Hume Disruption": "2.0m", "Gravity Resistance": "N/A", "Temporal Phasing": "None", "Speed": "Inhuman" } }
            ],
            ...
            lore: makeLore([
                ...
                ["Architectural generation during level transition.", "Replacing ordinary walls when a wanderer is not looking.", "Manifesting in clusters in Level 188."],
                ["Walking away further than 10 meters breaks the psychic lure.", "Covering the glass fully neutralizes the entity's ability to hunt."]
            ),
            survivalGuide: makeSG(
                [
                    ...
                    {n:"Mirror Check",d:"Windows don't reflect light properly.",c:"teal",l:"Shine a flashlight into the glass. If the beam disappears instead of bouncing back, it is an entity."}
                ], 
